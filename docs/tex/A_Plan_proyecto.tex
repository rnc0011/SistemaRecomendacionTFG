...
Según un informe de \textit{Adecco} en 2015 \cite{sueldo-junior}, los informáticos junior cobraban alrededor de \EUR{17.248} brutos al año. Sabiendo esto, el desglose quedaría:

\tablaSinColores{Coste de personal}{l l}{2}{coste-personal}
{\textbf{Concepto} & \textbf{Coste} \\}{
	Salario mensual neto & \EUR{1.202,76} \\
	Seguridad Social & \EUR{91,27} \\ 
	Retención IRPF & \EUR{143,31} \\
	Salario mensual bruto & \EUR{1.437,33} \\
	\midrule
	\textbf{Total 5 meses} & \EUR{7.186,65} \\
}
...
\tablaSinColores{Coste hardware}{l l l}{3}{coste-hardware}
{\textbf{Concepto} & \textbf{Coste} & \textbf{Coste amortizado 5 meses} \\}{
	Ordenador Personal (Bundle) & \EUR{1.200} & \EUR{100} \\
	Hardware alquilado (al mes) & \EUR{437,34} & - \\
	\midrule
	\textbf{Total} & \EUR{3.386,7} & \EUR{2.286,7} \\
}
...
\tablaSinColores{Coste software}{l l l}{3}{coste-software}
{\textbf{Concepto} & \textbf{Coste} & \textbf{Coste amortizado 5 meses} \\}{
	Windows 10 Pro & \EUR{259} & \EUR{53,96} \\
	\midrule
	\textbf{Total} & \EUR{259} & \EUR{53,96} \\
}
...
\tablaSinColores{Costes varios}{l l}{2}{costes-varios}
{\textbf{Concepto} & \textbf{Coste} \\}{
	Alquiler oficina al mes & \EUR{450} \\
	Conexión a internet al mes & \EUR{80} \\
	Material de ofician & \EUR{150} \\
	\midrule
	\textbf{Total} & \EUR{11.800} \\
}

\textbf{Coste total:}

Teniendo en cuenta todos los costes anteriores, desarrollar este proyecto costaría \EUR{21.327,31}.

\tablaSinColores{Coste total}{l l}{2}{coste-total}
{\textbf{Concepto} & \textbf{Coste} \\}{
	Humano & \EUR{7.186,65} \\
	Hardware & \EUR{2.286,7} \\
	Software & \EUR{53,96} \\
	Varios & \EUR{11.800} \\
	\midrule
	\textbf{Total} & \EUR{21.327,31} \\
}
...
\tablaSinColores{Herramientas y sus licencias}{l l l}{3}{licencias}
