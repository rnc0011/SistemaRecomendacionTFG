...
\begin{abstract}
The main topic of the project are the recommendation systems. These tools generate predcitions on items that can be relevant to the users. Their impact is so big that practically every big company that offers any kind of service uses them. The goal is to compare the performance between classic models and those based on deep learning on different datasets.
